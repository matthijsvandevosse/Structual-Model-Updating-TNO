...
modeIndex = 1:3; % Indexes of these measured modes
...
structModel.K_j{3} = sparse(Kdiff3);   
structModel.K_j{4} = sparse(Kdiff4); 
...
psiExpAll([3], n) = L(3,i);
psiExpAll([4], n) = L(5,i);
psiExpAll([5], n) = 0.99*L(1,i);
psiExpAll([6], n) = 0.99*L(2,i);
psiExpAll([7], n) = 0.99*L(3,i);
psiExpAll([8], n) = 0.99*L(5,i);
n = n+1;
end
